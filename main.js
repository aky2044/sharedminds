...
const VISUAL_PROMPT_INSTRUCTION =
    "Rules: ONE line only. Use 8 to 18 words. Include at least 2 nouns and 1 adjective. Do not use the words short, prompt, description, or output. No quotes, no explanation. The image must clearly illustrate this thought. Thought: ";

function getImageStyleSuffix() {
    return ", highly abstract, oil or acrylic painting, thick impasto, visible brushstrokes, heavy film grain, strong pixelation, loose and suggestive, not literal, atmospheric, fine art";
}
...
function buildImagePrompt(imagePrompt, conveyingThought) {
    ...
    return noText + "Highly abstract oil or acrylic painting of " + imagePrompt + ", loose and suggestive. Conveying: \"" + conveyingThought + "\"." + getImageStyleSuffix();
}
